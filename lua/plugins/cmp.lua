return {
  ...
  --     }
  --
  --     -- Performance: increase debounce to reduce lag while typing
  --     opts.performance = {
  --       debounce = 300,        -- Wait 300ms after typing stops before showing completions
  --       throttle = 100,        -- Throttle completion requests
  --       fetching_timeout = 200,
  --       async_budget = 1,      -- Limit async work per cycle
